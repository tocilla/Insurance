...
class TestRiskTypeAPIViews(TestCase):
    def setUp(self):
        ...
        RiskField.objects.create(name='Required Text Field',risk_type_id=self.risk_type.pk,type='text',required=True)
        RiskField.objects.create(name='Text Field',risk_type_id=self.risk_type.pk,type='text',required=False)
